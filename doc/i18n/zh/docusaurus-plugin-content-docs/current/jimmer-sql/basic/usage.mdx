...
depdencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-sql:0.7.19'
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.7.19'
...
depdencies {
    ...
    implementation("org.babyfish.jimmer:jimmer-sql-kotlin:0.7.19")

    // 第三步: 应用ksp插件
	ksp("org.babyfish.jimmer:jimmer-ksp:0.7.19")
