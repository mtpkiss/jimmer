...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.4.11'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.4.11'
...
dependencies {
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.4.11")
    // highlight-next-line
    ksp("org.babyfish.jimmer:jimmer-ksp:0.4.11")
