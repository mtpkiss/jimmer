...
dependencies {
    ...
    implementation 'org.babyfish.jimmer:jimmer-core:0.5.1'

    // highlight-next-line
    annotationProcessor 'org.babyfish.jimmer:jimmer-apt:0.5.1'
...
dependencies {
    implementation("org.babyfish.jimmer:jimmer-core-kotlin:0.5.1")
    // highlight-next-line
    ksp("org.babyfish.jimmer:jimmer-ksp:0.5.1")
